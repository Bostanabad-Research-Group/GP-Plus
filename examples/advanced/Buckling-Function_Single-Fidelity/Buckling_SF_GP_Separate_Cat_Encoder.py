...
Same training stack: float64, LBFGSScipy.
"""
...
for seed in range(start_seed, start_seed + num_seeds):
    ...
    for encoder_mode in encoder_modes:
        ...
        if encoder_mode == "matrix":
            ...
            print("---------------------------------------------------")
            print("Using MatrixEncoder for cat encoders")
            print("---------------------------------------------------")
            cat_encoder = [
            ...
            print("---------------------------------------------------")
            print("Using NeuralEncoder for cat encoders")
            print("---------------------------------------------------")
            cat_encoder = [
...
for encoder_mode, run_metrics in metrics_by_encoder.items():
    ...
    print(f"\n=== Buckling SF (separate E/K/I groups, {run_label}Encoder) ===")
    print(
